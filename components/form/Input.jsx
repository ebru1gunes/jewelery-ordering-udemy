...
const Input = (props) => {
  ...
  return (<div className="w-full">
    <label className="relative block cursor-text w-full">
        ...
        <span className="absolute top-0 left-0 px-4 text-sm
        flex h-full peer-focus:h-7 peer-focus:text-xs 
        peer-valid:h-7 peer-valid:text-xs transition-all">{placeholder}</span>
