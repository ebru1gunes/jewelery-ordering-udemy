...
const Cart = () => {
  ...
  return(
   ...
   <div className="md:min-h-[calc(100vh_-_433px)] flex items-center 
   flex-1 p-10 overflow-x-auto w-full">
        ...
        {cart.products.map((product) => (
                ...
                >
                  <td className="py-4 px-6 font-medium whitespace-nowrap hover:text-white flex items-center gap-x-1 justify-center">
                    <Image src="/resimler/kolye2.png" alt="" width={50} height={50} />
    ...
    flex-col justify-center text-white p-12 md:w-auto w-full   md:text-start !text-center">
      ...
      <div className="mt-6">
          ...
          <button className="btn-primary mt-4 bg-yellow-500 md:w-auto w-52 
...
<tr className="transition-all bg-secondary border-gray-700 hover:bg-yellow-500 ">
<td className="py-4 px-6 font-medium whitespace-nowrap hover:text-white 
flex items-center gap-x-1 justify-center">
<Image src="/resimler/kolye2.png" alt="" width={50} height={50}/>
 <span>Kırmızı Kalpli Kolye</span>
</td>
